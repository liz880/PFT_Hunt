                  ...
                  children: [
                    ...
                    OutlinedButton(
                      style: OutlinedButton.styleFrom(
                          backgroundColor:
                              stateA ? Colors.redAccent : Colors.white70),
                      onPressed: () {
                        setState(() {
                          stateA = !stateA;
                        });
                    ...
                    OutlinedButton(
                      style: OutlinedButton.styleFrom(
                          backgroundColor:
                              stateB ? Colors.redAccent : Colors.white70),
                      onPressed: () {
                        setState(() {
                          stateB = !stateB;
                        });
                ...
                Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "The Dean Suite houses key administrative offices within Patrick F. Taylor Hall, although students typically do not visit for administrative purposes. Instead, the suite serves a more behind-the-scenes role in supporting the operations of the building and the LSU College of Engineering.",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                            fontSize: 20,
                          ),
